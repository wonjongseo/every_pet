...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ja_JP': {
          ...
          AppString.todayText: AppString.todayTextJp,
        ...
        'ko_KR': {
          ...
          AppString.todayText: AppString.todayTextKr,
        ...
        'en_US': {
          ...
          AppString.todayText: AppString.todayTextEn,
          AppString.editProfile: AppString.editProfileEn,
          AppString.meiText: AppString.meiTextEn,
          AppString.editMenuText: AppString.editMenuTextEn,
          AppString.perOneDayText: AppString.perOneDayTextEn,
          AppString.addMenuMsg: AppString.addMenuMsgEn,
          AppString.addmMenuText: AppString.addmMenuTextEn,
          AppString.calculateKcalScreenSubText:
              AppString.calculateKcalScreenSubTextEn,
          AppString.menuText: AppString.menuTextEn,
          AppString.requiredText: AppString.requiredTextEn,
          AppString.requiredMsg: AppString.requiredMsgEn,
          AppString.appName: AppString.appNameEn,
          AppString.nameCtrHintText: AppString.nameCtrHintTextEn,
          AppString.weightCtrHint: AppString.weightCtrHintEn,
          AppString.birthdayCtrHint: AppString.birthdayCtrHintEn,
          AppString.genderText: AppString.genderTextEn,
          AppString.kyoseiTr: AppString.kyoseiEn,
          AppString.fuinnTr: AppString.fuinnEn,
          AppString.pregentText: AppString.pregentTextEn,
          AppString.regularHospital: AppString.regularHospitalEn,
          AppString.hasipitalCtrHintTr: AppString.hasipitalCtrHintEn,
          AppString.hasipitalNumCtrHintTr: AppString.hasipitalNumCtrHintEn,
          AppString.regularTrmingShopName: AppString.regularTrmingShopNameEn,
          AppString.regularTrmingShopNumber:
              AppString.regularTrmingShopNumberEn,
          ...
          AppString.weightTextTr: AppString.weightTextEn,
          ...
          AppString.stamp1Tr: AppString.stamp1En,
          AppString.stamp2Tr: AppString.stamp2En,
          AppString.stamp3Tr: AppString.stamp3En,
          AppString.stamp4Tr: AppString.stamp4En,
          AppString.stamp5Tr: AppString.stamp5En,
          AppString.stamp6Tr: AppString.stamp6En,
          AppString.stamp7Tr: AppString.stamp7En,
          AppString.stamp8Tr: AppString.stamp8En,
          AppString.sufficMaleText: AppString.sufficMaleTextEn,
          AppString.sufficFeMaleTextTr: AppString.sufficFeMaleTextEn,
...
class AppString {
  ...
  static String editProfileEn = "Edit Profile";
  ...
  static String calculateKcalScreenSubTextEn =
      "Add Meal and Calculate Calories";

  static String menuText = 'menuTextTr';
  static String menuTextKr = '식단';
  static String menuTextJp = '献立';
  static String menuTextEn = "Meal";
  ...
  static String nameCtrHintTextEn = "Please Enter The Name";
  ...
  static String weightCtrHintEn = "Please Enter The Weight";
  ...
  static String pregentTextEn = "Pregent";
  ...
  static String editStampTextJp = "スタンプ編集";
  static String editStampTextEn = "Edit Stamp";
  ...
  static String sufficMaleTextEn = " (Mr)";
  ...
  static String sufficFeMaleTextEn = " (Ms)";
...
In other words, it means the amount of energy you need to rest.""";
  ...
  static String updateBtnTextEn = "Edit";
  ...
  static String completeText = "completeTextTr";
  ...
  static String addScheduleTextEn = "Add Schedule";
  ...
  static String updateExampleBtnEn = "Edit Schedule";
  ...
  static String enrollTextBtnEn = "Enroll";

  static String saveText = "saveTextTr";
  static String saveTextKr = '저장';
  static String saveTextJp = "保存";
  static String saveTextEn = "Save";

  static String savedText = "savedTextTr";
  static String savedTextKr = '저장됨';
